...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'sampleImageUploader1CreateModal',
            'url' => 'admin/sampleImageUploader1/createModal',
            'icon' => 'far fa-fw fa-file',
            'label' => 4,
            'label_color' => 'primary',
        ],
    ...
    */
    ...
    'plugins' => [
        ...
        'Select2' => [
            ...
            'files' => [
                [
                    ...
                    'location' => 'vendor/select2/4.0.3/js/select2.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
        ...
        // tempusdominusBootstrap4はデフォルトで記載されていない為追記する
        'TempusDominusBs4' => [
            'active' => true,
            'files' => [
                [
