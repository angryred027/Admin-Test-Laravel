<div class="sample-date-input form-group col-md-6">
    ...
    <div class="input-group @error('$name') adminlte-invalid-igroup @enderror  @error('testTime') adminlte-invalid-igroup @enderror">
        ...
        <input name={{$name . '_time'}} type="time" placeholder="HH:mm" label={{$name . '_time'}} :required="false" value="$startValue" step="1" class="form-control @error($name .'_time') is-invalid @enderror"/>
    </div>
    @error($name)
